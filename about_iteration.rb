...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Inject yields the first arg to input on the first iteration and
    # on each new iteration, yields the result of the last iteration.
    # Inject yields the second arg as each item in the array.
  end
